...
const BookingForm = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4 sm:p-6">
      <motion.div
        className="w-full max-w-2xl bg-white dark:bg-gray-800 shadow-2xl rounded-2xl overflow-hidden"
      ...
      >
        <div className="p-6 sm:p-8">
          <motion.h2
            className="text-3xl sm:text-4xl font-extrabold text-center text-gray-900 dark:text-white mb-6"
          ...
          <div className="mb-6 space-y-2 text-gray-700 dark:text-gray-300">
            <p className="text-lg font-medium">
              🌍 <span className="text-gray-900 dark:text-white font-semibold">Country:</span>{" "}
              {country}
            </p>
            <p className="text-lg font-medium">
              🏞️ <span className="text-gray-900 dark:text-white font-semibold">Place:</span>{" "}
              {place}
            </p>
          </div>
          ...
          <form className="space-y-4">
            <input
              ...
              className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500"
              required
            />
            <input
              type="tel"
            ...
            <select
              name="gender"
              onChange={handleChange}
              className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-300 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white"
            >
